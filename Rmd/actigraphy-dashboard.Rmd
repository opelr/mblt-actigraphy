...
avg_sleep <- aggregate(Sleep_Thresh_Smooth ~ patient_ID + Date + Day, actigraphy_static, table) %>%
  as.data.frame.table(.) %>%
...
### TST
```{r tst}
ggplot(results$TST, aes(patient_ID, TST_minutes)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_errorbar(aes(ymax = ymax, ymin = ymin)) +
  labs(y = "Total Sleep Time (min.)") +
