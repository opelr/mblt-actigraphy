...
actigraphy_headers_old <- tryRDS("./data/rds/actigraphy_header.rds")
actigraphy_static_old  <- tryRDS("./data/rds/actigraphy_static.rds")
actigraphy_filtered_old <- tryRDS("./data/rds/actigraphy_filtered.rds")
actigraphy_results_old <- tryRDS("./data/rds/actigraphy_results.rds")
...
try_save_RDS(actigraphy, actigraphy_static_old, "patient_ID", "./data/rds/actigraphy_static.rds")
message("Message: Saved... Headers & Static DataFrame")

## Validation
validate_actigraphy <- readRDS("./data/rds/actigraphy_static.rds")
...
# actigraphy <- readRDS("./data/rds/actigraphy_static.rds")
...
actigraphy <- actigraphy %>% 
  merge(., off_wrist[,c("patient_ID", "Noon_Day", "At_Least_96_Hours_On")],
...
saveRDS(results_bind, "./data/rds/actigraphy_results.rds")
